...
class Order
{
    ...
    protected $id;
    /**
     * @OneToOne(targetEntity="Pantona\Customers\Entity\Customer")
     */
    protected $customer;
    /**
     * @OneToOne(targetEntity="Pantona\Customers\Entity\Customer")
    ...
    protected $discount;
    /**
     * @ManyToOne(targetEntity="Pantona\Orders\Entity\Status")
     */
    protected $status;
    /**
     * @ManyToOne(targetEntity="Pantona\Core\Entity\Session")
     */
    protected $session;
    /**
     * @Column(type="integer")

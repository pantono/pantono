...
namespace Pantona\Acl\Controller;

use Pantona\Core\Model\Controller\Admin;
...
class Authentication extends Admin
{
    ...
    /**
     * @return \Pantona\Acl\AdminAuthentication
     */
    private function getAuthenticationModel()
    {
        return $this->getApplication()->getPantonaService('AdminAuthentication');
    }
